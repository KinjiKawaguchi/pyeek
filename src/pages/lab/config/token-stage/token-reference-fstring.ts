...
export const TOKEN_REFERENCE_FSTRING: TokenReference[] = [
  {
    ...
    docUrl: "https://docs.python.org/3.12/library/token.html#token.FSTRING_START",
  ...
  },
  {
    ...
    docUrl: "https://docs.python.org/3.12/library/token.html#token.FSTRING_MIDDLE",
    easy: "F-string の中の、文字としてそのまま表示される部分だけ。{ } の中身は別のトークンとして扱われる。",
  },
  {
    name: "FSTRING_END",
    detail: "F-string の終了。\" や ' などの閉じ引用符を示します。FSTRING_START に対応します。",
    docUrl: "https://docs.python.org/3.12/library/token.html#token.FSTRING_END",
