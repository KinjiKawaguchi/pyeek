...
— で、同じソースコードがどう姿を変えていくかを可視化する教育用 Web アプリです。
...
- [ ] **多言語対応（i18n）** — UI文言・全種別リファレンス（①〜③、約280項目）を英語等に対応させる。リファレンスの分量が大きいため翻訳運用の設計から要検討。

### 教育コンテンツ
- [x] **プリセット拡充** — 内包表記・ジェネレータ・デコレータ・クラス・クロージャの例を追加済み。
